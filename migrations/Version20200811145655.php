 ...
 */
final class Version20200811145655 extends AbstractMigration
{
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE competence_niveau_evaluation (competence_id INT NOT NULL, niveau_evaluation_id INT NOT NULL, INDEX IDX_E1E4DE6855CCA3C7 (niveau_evaluation_id), INDEX IDX_E1E4DE6815761DAB (competence_id), PRIMARY KEY(competence_id, niveau_evaluation_id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
        ...
        $this->addSql('CREATE TABLE tag_groupe_tag (tag_id INT NOT NULL, groupe_tag_id INT NOT NULL, INDEX IDX_2932D77FD1EC9F2B (groupe_tag_id), INDEX IDX_2932D77FBAD26311 (tag_id), PRIMARY KEY(tag_id, groupe_tag_id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
