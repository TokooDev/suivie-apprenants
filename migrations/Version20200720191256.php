 ...
 */
final class Version20200720191256 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE apprenant (id INT AUTO_INCREMENT NOT NULL, profildesortie_id INT DEFAULT NULL, prenom VARCHAR(60) NOT NULL, nom VARCHAR(60) NOT NULL, email VARCHAR(255) NOT NULL, tel VARCHAR(255) NOT NULL, avatar VARCHAR(255) NOT NULL, INDEX IDX_C4EB462ECEB2FD19 (profildesortie_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE user (id INT AUTO_INCREMENT NOT NULL, profil_id INT NOT NULL, username VARCHAR(180) NOT NULL, roles JSON NOT NULL, password VARCHAR(255) NOT NULL, prenom VARCHAR(60) NOT NULL, nom VARCHAR(60) NOT NULL, email VARCHAR(255) NOT NULL, tel VARCHAR(255) NOT NULL, avatar VARCHAR(255) NOT NULL, UNIQUE INDEX UNIQ_8D93D649F85E0677 (username), INDEX IDX_8D93D649275ED078 (profil_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
